...
func EncodeSumRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
...
func DecodeSumResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
...
func (c *Client) BuildMulRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		numbers []string
	)
	{
...
func EncodeMulRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*math.MulPayload)
		if !ok {
...
//   - "MalformedPayload" (type *goa.ServiceError): http.StatusBadRequest
//   - error: internal error
func DecodeMulResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
